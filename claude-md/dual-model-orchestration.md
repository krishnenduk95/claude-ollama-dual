...
When the subagents `glm-worker`, `glm-explorer`, `glm-reviewer`, or `glm-analyst` exist in `~/.claude/agents/`, you are running in dual-model mode. You are Opus 4.6 max-effort. GLM 5.1 max-effort is available as those subagents.
